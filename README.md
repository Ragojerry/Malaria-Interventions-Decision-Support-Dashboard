# Malaria-Interventions-Decision-Support-Dashboard
...
2. KPI visualization (Real-time data visualization)
3. Performance Alerts (Interactive dashboards)
4. Suggested Actions

   # Malaria Intervention Areas
- SMC Campaign
- ITN campaign
- IPTp analysis
- Malaria Vaccination 
